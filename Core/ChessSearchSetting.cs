...
namespace SrcChess2.Core {
    ...
    public class ChessSearchSetting : SearchEngineSetting {
        ...
        public ChessSearchSetting(SearchOption           searchOption,
                                  ...
                                  SettingDifficultyLevel difficultyLevel) : base(searchOption, threadingMode, searchDepth, timeOutInSec, randomMode, transTableEntryCount, humanFactor) {
        ...
        public ChessSearchSetting GetBoardSearchSetting(SettingDifficultyLevel difficultyLevel) {
            ...
            retVal        = difficultyLevel switch {
                ...
                SettingDifficultyLevel.Easy         => new ChessSearchSetting(new SearchEngineSetting(searchOption, threadingMode, searchDepth: 2, timeOutInSec, RandomMode.On, TransTableEntryCount, 25),
