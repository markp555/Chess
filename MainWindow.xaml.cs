...
namespace SrcChess2 {
    ...
    public partial class MainWindow : Window {
        ...
        private void PlayComputer(bool flash) {
            StartAsyncComputing();
            if (!m_chessCtl.FindBestMove(null, PlayComputerEnd, flash)) {
                UnlockBoard();
            }
        }
        ...
        private void SetFicsHeader(FicsInterface.FicsGame? game) {
            if (game != null) {
                ...
                //m_toolbar.labelEvaluationResult.Visibility = Visibility.Collapsed;
            } else {
                ...
                m_toolbar.labelEvaluationResult.Visibility = Visibility.Visible;
            }
        }
        ...
        /// <param name="sender"> Sender object</param>
        /// <param name="e">      Event arguments</param>
        private void ChessCtl_FindMoveEnd(object? sender, EventArgs e)
        {
            m_toolbar.EndProgressBar();
        }
        ...
        private void ChessCtl_NewMove(object? sender, ChessBoardControl.NewMoveEventArgs e) {
            ...
            AttackPosInfo posInfo;
            m_chessCtl.ChessBoard.ComputePiecesCoverage(m_chessCtl.ChessBoard.CurrentPlayer, out posInfo);
            m_toolbar.labelEvaluationResult.Content = ((float)(m_chessCtl.ChessBoard.Points(
                m_chessSearchSetting,
                m_chessCtl.ChessBoard.CurrentPlayer,
                0, posInfo, posInfo) / 10) / 10).ToString();
            DoAutomaticMove();
        }
